...
- RSSI result input: `datasets\processed\probe_sweep_run04\reconciliation\recon_900pairs\reconciliation_demo_result.json`
...
| RSSI-bound EDHOC | 890 | 117 | 146524.928 ms | True | True | True | True |

## RSSI-bound EDHOC details

- Usable RSSI bits: `188`
- BDR before reconciliation: `0.0`
- Mismatches after reconciliation: `0`
- Estimated min-entropy after leakage: `78.32581083536968`
