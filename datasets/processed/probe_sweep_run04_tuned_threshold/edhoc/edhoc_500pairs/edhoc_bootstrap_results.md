...
- RSSI result input: `datasets\processed\probe_sweep_run04_tuned_threshold\reconciliation\recon_500pairs\reconciliation_demo_result.json`
...
| RSSI-bound EDHOC | 494 | 117 | 81441.536 ms | True | True | True | True |

## RSSI-bound EDHOC details

- Usable RSSI bits: `347`
- BDR before reconciliation: `0.0`
- Mismatches after reconciliation: `0`
- Estimated min-entropy after leakage: `200.51715397354167`
