...
- RSSI result input: `datasets\processed\probe_sweep_run04_tuned_threshold\reconciliation\recon_450pairs\reconciliation_demo_result.json`
...
| RSSI-bound EDHOC | 444 | 117 | 73223.936 ms | True | True | True | True |

## RSSI-bound EDHOC details

- Usable RSSI bits: `298`
- BDR before reconciliation: `0.0`
- Mismatches after reconciliation: `0`
- Estimated min-entropy after leakage: `202.2623578767741`
