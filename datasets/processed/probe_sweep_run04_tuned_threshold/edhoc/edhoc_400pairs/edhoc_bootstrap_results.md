...
- RSSI result input: `datasets\processed\probe_sweep_run04_tuned_threshold\reconciliation\recon_400pairs\reconciliation_demo_result.json`
...
| RSSI-bound EDHOC | 394 | 117 | 65006.336 ms | True | True | True | True |

## RSSI-bound EDHOC details

- Usable RSSI bits: `254`
- BDR before reconciliation: `0.0`
- Mismatches after reconciliation: `0`
- Estimated min-entropy after leakage: `164.91034876254395`
