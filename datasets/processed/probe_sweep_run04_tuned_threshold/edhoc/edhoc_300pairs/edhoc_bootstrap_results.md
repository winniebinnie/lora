...
- RSSI result input: `datasets\processed\probe_sweep_run04_tuned_threshold\reconciliation\recon_300pairs\reconciliation_demo_result.json`
...
| RSSI-bound EDHOC | 296 | 117 | 48899.84 ms | True | True | True | True |

## RSSI-bound EDHOC details

- Usable RSSI bits: `162`
- BDR before reconciliation: `0.0`
- Mismatches after reconciliation: `0`
- Estimated min-entropy after leakage: `109.50027797715006`
